	...
	function letra(){
		...
		if(strlen($cnumero)>15){
			...
			if($this->mayusculas){//mayusculas
				$texto=strtoupper("SON ".$this->prefijo.$texto." ".$this->moneda." ".substr($cnumero,-2)."/100 ".$this->sufijo);	
			}else{//minusculas
				$texto=strtolower("Son ".$this->prefijo.$texto." ".$this->moneda." ".substr($cnumero,-2)."/100 ".$this->sufijo);	
			}
		}
		return $texto;
