...
$objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('B'.$ini, 'Status')
            ->setCellValue('C'.$ini, 'Fecha')
            ->setCellValue('D'.$ini, 'Forma de Pago')
            ->setCellValue('E'.$ini, 'Usuario')
...
$objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('B'.$num, $row->estatus)
            ->setCellValue('C'.$num, $row->fecha)
            ->setCellValue('D'.$num, $row->forma_de_pago)
            ->setCellValue('E'.$num, $row->usuario)
            ->setCellValue('F'.$num, $row->abono)
;
            $num++;
...
header('Content-Disposition: attachment;filename="auditoria_'.date('YmdHsi').'.xlsx"');
